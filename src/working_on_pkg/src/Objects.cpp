#include "../include/working_on_pkg/Objects.h"
#include <cstdio>
#include <tuple>
using std::cout;
...
Objects::Objects(){
    list_objects_.open("../../../src/working_on_pkg/config/list_objects.txt", std::ios::in);
...
void Objects::readObjectListFromFile(std::string file_address, SearchingMode searchingMode){
    //"src/working_on_pkg/config/list_objects.txt"
